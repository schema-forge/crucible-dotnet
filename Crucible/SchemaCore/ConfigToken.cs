...
namespace SchemaForge.Crucible
{
  ...
  public abstract class ConfigToken
  {
    ...
    public JProperty ToJProperty() => new JProperty(TokenName, new JObject() { { "Constraints", JsonConstraint.Count > 1 ? JsonConstraint : JsonConstraint[0] }, { "Description", Description } });
  ...
  public class ConfigToken<Type1, Type2, Type3> : ConfigToken
  {
    ...
    public override ConfigToken AddNewType<TNewType>(Constraint<TNewType>[] newConstraints = null)
    {
      throw new NotImplementedException("A ConfigToken cannot have more than 3 types.");
    }
