...
namespace SchemaForge.Crucible
{
  ...
  public abstract class Field
  {
    ...
    /// </summary>
    public List<Error> ErrorList { get; protected set; } = new List<Error>();
    ...
    public virtual bool Validate<TCollectionType>(TCollectionType collection, ISchemaTranslator<TCollectionType> translator)
    {
      ...
      {
        ErrorList.Add(new Error($"Value of field {FieldName} is null or empty.", AllowNull?Severity.Warning:Severity.Fatal));
      }
  ...
  public class Field<Type1> : Field
  {
    ...
    public override bool Validate<TCollectionType>(TCollectionType collection, ISchemaTranslator<TCollectionType> translator)
    {
      ...
      {
        ErrorList.Add(new Error($"Field {FieldName} with value {translator.CollectionValueToString(collection, FieldName)} is an incorrect type. Expected one of: {typeof(Type1).Name} ({translator.GetEquivalentType(typeof(Type1).Name)})", Severity.Fatal));
      }
      return !ErrorList.AnyFatal();
    }
  }
  ...
  public class Field<Type1, Type2> : Field
  {
    ...
    public override bool Validate<TCollectionType>(TCollectionType collection, ISchemaTranslator<TCollectionType> translator)
    {
      ...
      {
        ErrorList.Add(new Error($"Field {FieldName} with value {translator.CollectionValueToString(collection, FieldName)} is an incorrect type. Expected one of: {typeof(Type1).Name} ({translator.GetEquivalentType(typeof(Type1).Name)}), {typeof(Type2).Name} ({translator.GetEquivalentType(typeof(Type2).Name)})", Severity.Fatal));
      }
      return !ErrorList.AnyFatal();
    }
  }
  ...
  public class Field<Type1, Type2, Type3> : Field
  {
    ...
    public override bool Validate<TCollectionType>(TCollectionType collection, ISchemaTranslator<TCollectionType> translator)
    {
      ...
      {
        ErrorList.Add(new Error($"Field {FieldName} with value {translator.CollectionValueToString(collection, FieldName)} is an incorrect type. Expected one of: {typeof(Type1).Name} ({translator.GetEquivalentType(typeof(Type1).Name)}), {typeof(Type2).Name} ({translator.GetEquivalentType(typeof(Type2).Name)}), {typeof(Type3).Name} ({translator.GetEquivalentType(typeof(Type3).Name)})", Severity.Fatal));
      }
      return !ErrorList.AnyFatal();
    }
  }
