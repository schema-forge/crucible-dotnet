      ...
      testSchema.AddTokens(new HashSet<ConfigToken>()
            {
                ...
                new ConfigToken<string>("ConstrainStringLengthLowerBound","String: Minimum length of 3.",new Constraint<string>[] { ConstrainStringLengthLowerBound(3) }, required: false),
                ...
                new ConfigToken<JObject>("ConstrainCollectionCountLowerBound","Why have you scrolled this far? The heat of the forge sears me. I can no longer remember the coolness of a summer day.",new Constraint<JObject>[] { ConstrainCollectionCountLowerBound<JObject>(1) }, required: false),
                ...
                new ConfigToken<JArray>("ConstrainCollectionCountLowerBound","BURN WITH ME, MARTHA.",new Constraint<JArray>[] { ConstrainCollectionCountLowerBound<JArray>(1) }, required: false),
