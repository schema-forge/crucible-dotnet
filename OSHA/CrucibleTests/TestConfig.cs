    ...
    public class TestConfig : Schema
    {
        TestConfig(JObject inputConfig)
        {
            ...
            OptionalConfigTokens.UnionWith(new HashSet<ConfigToken>()
            {
                ...
                new ConfigToken("ApplyConstraintsToArrayElements","hurry",ApplyConstraints<JArray>(ApplyConstraintsToAllArrayValues(ApplyConstraints<string>(ConstrainStringValues("under the smelters", "in the tunnels beneath", "help us")))))
            });
        }
    }
}
